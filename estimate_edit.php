...
<div style="display:flex; justify-content: center;">
    ...
    <div style="width:1002px;">
                ...
                <table style="border: 1px solid black; font-weight: 600;color:black;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>E-mail</td>
                            <td><?=explode("@",$email)[0]?></br>@<?=explode("@",$email)[1]?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan='7'>
                                <div style="display:flex;justify-content: flex-end;">
                                    ₩ <textarea id="sum4" class="textarea-right"></textarea>
                                </div>
                            </td>
                        </tr>
                    </tbody>
        ...
        <div style="text-align: right;margin-top:5px;">
            <button type="button" class="btn btn-dark" onclick="printTable()">인  쇄</button>
        </div>
    </div>
...
<script>
    ...
    function printTable() {
        ...
        var originalWindow = window.open('', '_blank');

        // 새 창에 필요한 스타일과 함께 복사된 내용을 삽입
        ...
        saveContentToFile("../data/list/"+document.getElementById('target').value + "(" +document.getElementById('date').value+ ').txt',printContents);

        originalWindow.document.close();
        originalWindow.focus(); // 새 창에 포커스를 맞춤
        originalWindow.print(); // 인쇄 대화 상자 열기
        originalWindow.close(); // 인쇄 후 새 창 닫기
    }
